...
export function Sidebar({ activePage, onNavigate, onLogout, mobileOpen, onCloseMobile, userRole }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed lg:sticky top-0 left-0 h-screen w-64 bg-linear-to-b from-sky-900 via-sky-800 to-cyan-900 text-white flex flex-col z-50 transition-transform duration-300',
