...
export const rolePermissions = {
  ceo: ['dashboard', 'customers', 'sales', 'payments', 'inventory', 'supply', 'receipts', 'reports', 'settings', 'users', 'operator'],
  admin: ['dashboard', 'customers', 'sales', 'payments', 'inventory', 'supply', 'receipts', 'reports', 'settings', 'users', 'operator'],
  manager: ['dashboard', 'customers', 'sales', 'payments', 'inventory', 'supply', 'receipts', 'reports', 'operator'],
  supervisor: ['dashboard', 'sales', 'payments', 'inventory', 'supply', 'receipts', 'operator'],
